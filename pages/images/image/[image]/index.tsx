...
import { getDetailedData, setNewRecentImage } from "@/components/utils";
...
const SingleImage = () => {
    ...
    const onSelect = (x: number, y: number) => {
        ...
        for (let i = 0; i < globalPenSize; i++) {
            for (let ii = 0; ii < globalPenSize; ii++) {
    ...
    const downloadData = async () => {
        ...
        setNewRecentImage(imageIndex);
        const a = document.createElement("a");
        a.href = `/images/image/${imageIndex + 1}`;
        a.click();
    };
    ...
    const back = () => {
        ...
        const a = document.createElement("a");
        setNewRecentImage(num - 1);
        a.href = `/images/image/${num - 1}`;
        a.click();
    };
    const next = () => {
        const { image } = router.query;
                    ...
                    <div className="flex flex-col justify-center items-center h-[70vh] gap-2">
                        ...
                        <div className="flex flex-col justify-center items-center gap-2">
                            <div className="flex flex-col justify-center items-center gap-1">
                                <input
                                    ...
                                    onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                                        ...
                                        globalPenSize = Number(event.target.value);
                                    }}
                                />
                            ...
                            <div className="flex flex-row justify-center items-center gap-2">
                                ...
                                <button onClick={mainPage} className="p-4 rounded-lg bg-blue-600 hover:brightness-90 active:brightness-75">Main Image Page</button>
                            </div>
                        </div>
                    </div>
